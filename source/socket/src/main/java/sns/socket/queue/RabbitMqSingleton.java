package sns.socket.queue;

import org.apache.logging.log4j.Logger;

import com.rabbitmq.client.Address;
import com.rabbitmq.client.ConnectionFactory;
import sns.socket.thread.QueueThread;
import sns.socket.utils.QueueService;
import sns.queue.QueueListener;
import sns.queue.RabbitMqManager;
...
public class RabbitMqSingleton {
    ...
    private RabbitMqSingleton() {
        ...
        rabbitMqManager = new RabbitMqManager(factory, QueueService.getInstance().getIntResource("rabbit.prefetch"));
    ...
    public void startQueue() {
        ...
        QueueListener queueListener = new QueueListener() {
            ...
            public String getQueue() {
                String serverId = QueueService.getInstance().getStringResource("server.id");
                String queue = QueueService.getInstance().getStringResource("queue.broadcast");
                return serverId + "_" + queue;
            }
